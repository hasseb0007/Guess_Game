...
public class GameA7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_a7);
        setmAdView();
        init();
        initListener();
    }
    private void init(){
        ...
        intent_put = new Intent(this,Result.class);

        intent_get = getIntent();
        value_get= intent_get.getIntExtra("value_put", -1);
        if (value_get==-1 || value_get>31)
        {
            Toast.makeText(this,"Error in intent 7",Toast.LENGTH_SHORT).show();
