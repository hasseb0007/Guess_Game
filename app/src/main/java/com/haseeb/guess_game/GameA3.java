...
public class GameA3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_a3);
        setmAdView();
        init();
    ...
    private void init()
    {
        ...
        intent_put = new Intent(this,GameA4.class);

        intent_get = getIntent();
        value_get= intent_get.getIntExtra("value_put", -1);
        if (value_get==-1|| value_get>1)
        {
            Toast.makeText(this,"Error in intent 3",Toast.LENGTH_SHORT).show();
        }
    }
