...
public class GameA4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_a4);
        setmAdView();
        init();
        initListener();
    }
    private void init(){
        ...
        intent_put = new Intent(this,GameA5.class);

        intent_get = getIntent();
        value_get= intent_get.getIntExtra("value_put", -1);
        if (value_get==-1|| value_get>3)
        {
            Toast.makeText(this,"Error in intent 4",Toast.LENGTH_SHORT).show();
